...
namespace dotnetconf.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update dotnetconfDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update dotnetconfEfCoreEntityExtensionMappings to extend the IdentityUser entity
